...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFE14613);
  ...
  late Color primaryText = const Color(0xFCEEECEF);
  late Color secondaryText = const Color(0xFCEEECEF);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFCB440C);
  late Color secondary = const Color(0xFFFFBB0D);
  late Color tertiary = const Color(0xFF4741FF);
  late Color alternate = const Color(0xFFF19642);
