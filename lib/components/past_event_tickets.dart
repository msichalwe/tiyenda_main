...
import 'PastEventsModell.dart';
export 'up_coming_event_orders_model.dart';

class PastEventTicketsWidget extends StatefulWidget {
  const PastEventTicketsWidget({super.key});

  @override
  State<PastEventTicketsWidget> createState() =>
      _PastEventTicketsWidgetState();
}

class _PastEventTicketsWidgetState extends State<PastEventTicketsWidget> {
  late PastEventTicketsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PastEventTicketsModel());
