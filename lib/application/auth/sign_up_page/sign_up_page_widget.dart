...
class _SignUpPageWidgetState extends State<SignUpPageWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('signUpPage_update_app_state');
      FFAppState().update(() {});
    });
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'SIGN_UP_PAGE_PAGE_createAccount_ON_TAP');
                                                  logFirebaseEvent(
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'SIGN_UP_PAGE_PAGE_Text_tsld94ph_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Text_navigate_back');
                                                          context.safePop();
                                                        },
                      ...
                      child: ClipRRect(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl: getCORSProxyUrl(
                            'https://img.freepik.com/premium-photo/woman-with-phone-pink-background_220770-5884.jpg',
                          ),
