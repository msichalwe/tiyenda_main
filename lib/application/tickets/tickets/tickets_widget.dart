                                              ...
                                              itemBuilder:
                                                ...
                                                return Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'TICKETS_PAGE_Container_gybwlc3t_ON_TAP');
                                                      logFirebaseEvent(
                                                    ...
                                                    onLongPress: () async {
                                                      logFirebaseEvent(
                                                          'TICKETS_Container_gybwlc3t_ON_LONG_PRESS');
                                                      logFirebaseEvent(
                                                                  ...
                                                                  return WebViewAware(
                                                                    child:
                                                                      ...
                                                                      title: const Text(
                                                                          'Warning'),
                                                                      content: const Text(
                                                                          'You are about to delete this ticket. Should we proceed?'),
                                                                      actions: [
                                                                        TextButton(
                                                      ...
                                                      if (confirmDialogResponse) {
                                                        ...
                                                        setState(() {
                                                          FFAppState()
                                                              .updateDownloadedOrderListAtIndex(
                                                            eventIndex,
                                                            (_) => '',
                                                          );
                                                          FFAppState()
                                                              .removeAtIndexFromDownloadedTickets(
                                                                  eventIndex);
                                                        });
                                                        return;
                                                      } else {
