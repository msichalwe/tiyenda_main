            ...
            child: Scaffold(
              ...
              floatingActionButton: Visibility(
                ...
                child: FloatingActionButton.extended(
                  onPressed: () async {
                    logFirebaseEvent(
                        'TICKETS_COPY_FloatingActionButton_3h22ps');
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        FutureBuilder<ApiCallResponse>(
                                          future: EventsGroup.getEventOrdersCall
                                              .call(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            final columnGetEventOrdersResponse =
                                                snapshot.data!;
                                            return Builder(
                                              builder: (context) {
                                                final orders =
                                                    columnGetEventOrdersResponse
                                                        .jsonBody
                                                        .toList();
                                                      ...
                                                      return Visibility(
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'TICKETS_COPY_Container_nqvk37m3_ON_TAP');
                                                              logFirebaseEvent(
